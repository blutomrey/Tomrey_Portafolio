# -*- coding: utf-8 -*-
"""
Created on Sun Aug  9 20:18:47 2020

@author: Tomas Reyes Tellez
...
# Se importa los datos a utilizar desde la web
url_test = 'c:/tomas/python/titanic/test.csv'
url_train = 'c:/tomas/python/titanic/train.csv'

df_test = pd.read_csv(url_test)
df_train = pd.read_csv(url_train)

#Se guardan los datos en un archivo para siempre tenerlos disponibles
dir_test = 'c:/tomas/python/titanic/titanic_test.csv'
dir_train = 'c:/tomas/python/titanic/titanic_train.csv'
...
print(df_train.shape) # (891, 13) 891 filas y 13 columnas
print(df_test.shape) # (418, 12) 418 filas y 12 columnas
...
# regarding whether they survived or not
